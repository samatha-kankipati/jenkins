...
from ccengine.domain.identity.v2_0.request.credentials \
    import PasswordCredentials, ApiKeyCredentials, RackerPasswordCredentials
...
class Auth(BaseIdentityDomain):
    ...
    def __init__(self, passwordCredentials=None, apiKeyCredentials=None,
                 rackerPasswordCredentials=None,
        ...
        self.rackerPasswordCredentials = rackerPasswordCredentials
        self.token = token
    ...
    def _obj_to_json(self):
        ...
        if self.rackerPasswordCredentials is not None:
            ret[RackerPasswordCredentials.ROOT_TAG] = \
                self.rackerPasswordCredentials._obj_to_dict()
            ret[RackerPasswordCredentials.JSON_ROOT_TAG] = \
                self.rackerPasswordCredentials._obj_to_dict_domain()
