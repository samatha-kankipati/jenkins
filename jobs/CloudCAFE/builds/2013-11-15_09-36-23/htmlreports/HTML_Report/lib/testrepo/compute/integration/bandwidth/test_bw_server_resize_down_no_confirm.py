...
from testrepo.common.testfixtures.stacktach_db_compute_bandwidth_integration \
    import (BwBeforeResizeDownNoConfirmServerFixture,
            BwAfterResizeDownNoConfirmServerFixture,
            BwBeforeAndAfterResizeDownNoConfirmServerFixture,
            NoBwResizeDownNoConfirmServerFixture)


class BwBeforeResizeDownNoConfirmTests(
        BwBeforeResizeDownNoConfirmServerFixture):
    '''
...
class BwAfterResizeDownNoConfirmTests(BwAfterResizeDownNoConfirmServerFixture):
    '''
...
class BwBeforeAfterResizeDownNoConfirmTests(
        BwBeforeAndAfterResizeDownNoConfirmServerFixture):
    '''
...
class NoBwResizeDownNoConfirmTests(NoBwResizeDownNoConfirmServerFixture):
    '''
