...
from ccengine.domain.images.request.job_action import JobAction
...
class SchedulesClient(BaseMarshallingClient):
    ...
    def create_schedule(self, tenant=None, action=None, minute=None, hour=None,
                        day_of_month=None, month=None, day_of_week=None,
                        next_run=None, metadata=None, requestslib_kwargs=None):
    ...
    def update_schedule(self, id=None, hour=None, tenant=None, updated_at=None,
                        created_at=None, day_of_week=None, day_of_month=None,
...
class WorkersClient(BaseMarshallingClient):
    ...
    def create_worker(self, host=None, requestslib_kwargs=None):
        ...
        return self.request(
            'POST', self.url, response_entity_type=WorkerResponse,
            request_entity=worker, requestslib_kwargs=requestslib_kwargs)
    ...
    def list_workers(self, keys=None, values=None, requestslib_kwargs=None):
    ...
    def grab_next_job(self, id=None, action=None, requestslib_kwargs=None):

        full_url = "{0}/{1}/jobs".format(self.url, id)
        action = JobAction(action=action)

        return self.request('POST', full_url,
                            response_entity_type=JobResponse,
                            request_entity=action,
                            requestslib_kwargs=requestslib_kwargs)
