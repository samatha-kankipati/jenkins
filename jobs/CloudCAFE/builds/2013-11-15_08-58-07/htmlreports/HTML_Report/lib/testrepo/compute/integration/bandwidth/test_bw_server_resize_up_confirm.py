...
from testrepo.common.testfixtures.stacktach_db_compute_bandwidth_integration \
    import (BwBeforeResizeUpConfirmServerFixture,
            BwAfterResizeUpConfirmServerFixture,
            BwBeforeAndAfterResizeUpConfirmServerFixture,
            NoBwResizeUpConfirmServerFixture)


class BwBeforeResizeUpConfirmTests(BwBeforeResizeUpConfirmServerFixture):
    '''
...
class BwAfterResizeUpConfirmTests(BwAfterResizeUpConfirmServerFixture):
    '''
...
class BwBeforeAfterResizeUpConfirmTests(
        BwBeforeAndAfterResizeUpConfirmServerFixture):
    '''
...
class NoBwResizeUpConfirmTests(NoBwResizeUpConfirmServerFixture):
    '''
