...
class ImageListTest(ComputeFixture):
    ...
    def setUpClass(cls):
        ...
        cls.server1 = cls.compute_provider.create_active_server()
        cls.server2 = cls.compute_provider.create_active_server()
        ...
        cls.compute_provider.wait_for_image_status(cls.image2_id, NovaImageStatusTypes.ACTIVE)
    ...
    def test_list_images_with_detail_filter_by_type(self):
        ...
        images = self.images_client.list_images_with_detail(type=type)
