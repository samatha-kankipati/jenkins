...
class RaxSignupAPI_GetSignupLists_Positive(RaxSignupAPI_Common_Methods):
    ...
    def test_get_list_of_signups_with_status_as_complete(self):
        ...
        get_list_of_signups_resp = self.common_positive_steps(params).content
        geography_regex = 'region\":\"(US|UK)\",.+\"geography\":\"(US|UK)\"'
        self.assertIsNotNone(re.search(geography_regex,
                             get_list_of_signups_resp),
