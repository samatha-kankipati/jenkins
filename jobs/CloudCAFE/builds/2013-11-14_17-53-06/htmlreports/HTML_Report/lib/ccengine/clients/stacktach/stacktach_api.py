...
class StackTachClient(BaseMarshallingClient):
    ...
    def get_event_names(self, product, requestslib_kwargs=None):
        '''
        ...
        '''
            GET
            stacky/events/?service={product}
        '''
        params = {'service': product}
        url = ''.join([self.url, '/stacky/events/'])
        return self.request('GET', url, params=params,
                            response_entity_type=ResponseEntity,
                            requestslib_kwargs=requestslib_kwargs)

    def get_host_names(self, product, requestslib_kwargs=None):
        '''
    ...
    def get_events_for_uuid(self, uuid, product, requestslib_kwargs=None):
        '''
        ...
        '''
            GET
            stacky/uuid/?uuid={uuid}&service={product}
        '''
        params = {'uuid': uuid, 'service': product}
        url = "{url}/stacky/uuid/".format(url=self.url)
        return self.request('GET', url, params=params,
                            response_entity_type=ResponseEntity,
                            requestslib_kwargs=requestslib_kwargs)
    ...
    def get_watch_events(self, deployment_id, product,
        ...
        '''
            GET
            stacky/watch/{deployment_id}/?service={product}
        '''
        params = {'service': product}
        url = ("{url}/stacky/watch/{deployment_id}/"
               .format(url=self.url, deployment_id=deployment_id))
        return self.request('GET', url, params=params,
                            response_entity_type=ResponseEntity,
                            requestslib_kwargs=requestslib_kwargs)

    def get_event_id_details(self, event_id, product, requestslib_kwargs=None):
        '''
        ...
        '''
            GET
            stacky/show/{event_id}/?service={product}
        '''
        params = {'service': product}
        url = ("{url}/stacky/show/{event_id}"
               .format(url=self.url, event_id=event_id))
        return self.request('GET', url, params=params,
                            requestslib_kwargs=requestslib_kwargs)

    def get_event_type_details(self, event_type, product,
                               requestslib_kwargs=None):
        '''
        @todo XXXFN - the response is only formatted for command line
        @summary: Retrieves details of a given event
        ...
        '''
            ...
            &service={product}&limit={limit}
        '''
        params = {'field': 'event', 'value': event_type,
                  'service': product, 'limit': 10}
