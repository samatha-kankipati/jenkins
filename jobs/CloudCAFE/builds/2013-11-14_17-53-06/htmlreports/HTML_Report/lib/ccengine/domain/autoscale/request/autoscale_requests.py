...
class Webhook_Request(BaseMarshallingDomain):
...
class Update_Webhook_Request(BaseMarshallingDomain):
...
class Policy_Request(BaseMarshallingDomain):
...
class Update_Policy_Request(BaseMarshallingDomain):
...
class Group_Request(BaseMarshallingDomain):
...
class Config_Request(BaseMarshallingDomain):
...
class ScalingGroup_Request(BaseMarshallingDomain):
