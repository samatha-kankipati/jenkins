...
class RaxSignupAPI_CloudSignupRequest_PositiveSmoke(
    ...
    @attr('geography')
    def test_us_cloud_signup_request_minimal_with_geography(self):
        """
        Tests base test fixture default request
        """
    ...
    def test_us_cloud_signup_with_affiliate_code(self):
        """
    ...
    @attr('default_region')
    def test_us_cloud_signup_request_with_default_region_and_contract_as_ch(self):
        """
        Scenario to test us cloud with geo_location as SYD and with primary
        address AU and business_type BUSINESS
    ...
    def test_us_cloud_signup_with_default_region_and_geography_and_cloud_sites(self):
        """
        Scenario to test us cloud signup with geo_location as SYD and
        with Cloud Sites
    ...
    @attr('welcome_email')
    def test_us_cloud_signup_welcome_email(self):
        """
    ...
    @attr('welcome_email')
    def test_us_cloud_signup_with_defaultRegion(self):
        """
    ...
    @attr('welcome_email')
    def test_us_cloud_signup_with_service_level_core(self):
        """
