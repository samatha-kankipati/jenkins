...
class RaxSignupAPI_TrustedCloudSignupRequest_UK_PositiveSmoke(
    ...
    @attr('geography')
    def test_uk_trusted_cloud_signup_request_default_with_geography(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
        all necessary details
        """
    ...
    def test_uk_trusted_cloud_signup_with_affiliate_code(self):
        """
    ...
    @attr('welcome_email')
    def test_uk_trusted_cloud_signup_welcome_email(self):
        """
    ...
    @attr('welcome_email')
    def test_uk_trusted_cloud_signup_with_service_level_core(self):
        """
