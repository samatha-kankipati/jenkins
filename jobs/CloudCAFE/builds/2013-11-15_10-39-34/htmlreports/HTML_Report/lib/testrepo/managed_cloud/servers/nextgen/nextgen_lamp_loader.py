...
from ccengine.common.data_generators.managed_cloud.nextgen_lamp_generator \
    import ManagedCloudLinuxNextGenLampDataGenerator
from unittest2.suite import TestSuite


def load_tests(loader, standard_tests, pattern):
    suite = TestSuite()
    smoke_data_gen = ManagedCloudLinuxNextGenLampDataGenerator()
    ...
    custom_loader.addTest(ManagedLinuxNextGenServersTest(
        "test_backupagent_bootstrap"))
    custom_loader.addTest(ManagedLinuxNextGenServersTest(
        "test_monitoring_connected"))
    custom_loader.addTest(ManagedLinuxNextGenServersTest(
        "test_monitoring_authenticated"))
    custom_loader.addTest(ManagedLinuxNextGenServersTest(
        "test_monitoring_check_created"))
    custom_loader.addTest(ManagedLinuxNextGenServersTest(
        "test_yumcron_file"))
    custom_loader.addTest(ManagedLinuxNextGenServersTest(
