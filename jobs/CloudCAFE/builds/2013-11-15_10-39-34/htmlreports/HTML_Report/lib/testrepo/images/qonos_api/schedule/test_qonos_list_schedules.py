...
class TestQonosListSchedules(BaseImagesFixture):
        ...
        for sch in sch_list:
            ...
            self.assertLessEqual(created_at_diff_in_sec, 10,
                                 msg.format('created_at',
                                            current_sch.created_at,
                                            sch.created_at))
            self.assertLessEqual(updated_at_diff_in_sec, 10,
                                 msg.format('updated_at',
                                            current_sch.updated_at,
                                            sch.updated_at))
    ...
    def test_list_schedules_with_tenant_filter_only(self):
        ...
        self.assertEquals(len(list_sch), 0, msg.format("length of the list", 0,
                                                       len(list_sch)))
        ...
        self.assertEquals(len(list_sch), 1, msg.format("length of the list", 1,
                                                       len(list_sch)))
        ...
        self.assertEquals(len(list_sch), 2, msg.format("length of the list", 2,
                                                       len(list_sch)))
    ...
    def test_list_schedules_with_multiple_metadata_key_filters(self):
        ...
        5) Verify that the length of the returned list is 2
        6) List schedules with the retention filter only
        7) Verify that the length of the returned list is 1
        8) List schedules with both instance id and retention filters
        9) Verify that the length of the returned list is 1
        10) Verify expected schedules are returned
        """
    ...
    def test_list_schedules_next_run_after_filter_only(self):
        ...
        self.assertEquals(len(ret_schs), 2, msg.format("length of the list", 2,
                                                       len(ret_schs)))
    ...
    def test_list_schedules_next_run_after_filter_only_t1_distant_future(self):
        ...
        self.assertEquals(len(list_sch), count,
                          msg.format("length of the list", count,
                                     len(list_sch)))
    ...
    def test_list_schedules_next_run_before_filter_only(self):
        ...
        tenant = datagen.random_string(size=10)
        action = self.config.images.action
        # To set time/hour of the schedules differently from other tests
    ...
    def test_list_schedules_next_run_after_before_filter_only(self):
        ...
        self.assertEquals(len(list_sch), 3, msg.format("length of the list", 3,
                                                       len(list_sch)))
    ...
    def test_list_schedules_next_run_after_before_filter_t2(self):
        ...
        2) Create schedule with next_run of t2 (t2>t1)
        3) Create schedule with next_run of t3 (t3>t2)
        4) List schedules with next_run_after and next_run_before=t2
        5) Verify that the length of the returned list is 1 and lists the
        ...
        for sch in list_sch:
            if sch.tenant == tenant:
                self.assertIn("16:35:00Z", sch.next_run,
