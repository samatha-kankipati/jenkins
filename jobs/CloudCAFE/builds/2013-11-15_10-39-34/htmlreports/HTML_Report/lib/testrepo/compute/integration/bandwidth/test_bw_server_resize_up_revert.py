...
from testrepo.common.testfixtures.stacktach_db_compute_bandwidth_integration \
    import (BwBeforeResizeUpRevertServerFixture,
            BwAfterResizeUpRevertServerFixture,
            BwBeforeAndAfterResizeUpRevertServerFixture,
            NoBwResizeUpRevertServerFixture)


class BwBeforeResizeUpRevertTests(BwBeforeResizeUpRevertServerFixture):
    '''
...
class BwAfterResizeUpRevertTests(BwAfterResizeUpRevertServerFixture):
    '''
...
class BwBeforeAfterResizeUpRevertTests(
        BwBeforeAndAfterResizeUpRevertServerFixture):
    '''
...
class NoBwResizeUpRevertTests(NoBwResizeUpRevertServerFixture):
    '''
