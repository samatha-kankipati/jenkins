...
from ccengine.domain.types \
    import NovaServerStatusTypes, ScheduledImagesJobStatus
...
class TestQonosSetScheduleMetadata(BaseImagesFixture):
    ...
    def test_happy_path_append_schedule_metadata(self):
        ...
        self.assertEquals(len(get_sch_metadata), 2,
    ...
    def test_set_an_empty_schedule_metadata(self):
        ...
        self.assertEquals(len(list_sch_metadata_obj.entity), 0,
    ...
    def test_set_schedule_metadata_after_setting_empty_metadata(self):
        """Set schedule metadata after setting an empty schedule metadata.
    ...
    def test_set_schedule_metadata_after_job_created(self):
        ...
        self.assertGreater(len(jobs), 0, msg.format('Job', 'At least 1',
                                                    len(jobs)))
