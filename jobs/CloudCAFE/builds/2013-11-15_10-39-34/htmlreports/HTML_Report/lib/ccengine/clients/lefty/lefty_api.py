...
from ccengine.domain.lefty.response.lefty import Ticket, Category, \
    Subcategory, Queue, Statuses, PubSub, Tickets, Queues, Categories, \
    Subcategories
...
class LeftyAPITicketClient(BaseMarshallingClient):
    ...
    def list_tickets(self, account_id, ticket_status="", offset=0, count=50):
        """
        ...
        """
        url = '{0}/accounts/{1}/tickets/{2}?offset={3}&count={4}'.format(
            self.url, account_id, ticket_status, offset, count)
    ...
    def update_ticket(self, account_id, ticket_id, priority=None,
        ...
        """
            ...
            @param is_comment_public: Boolean to mark public comment for the
                                      ticket.
        ...
        lefty_response = self.request('PUT', url,
                                      request_entity=update_ticket_request_obj,
                                      response_entity_type=Ticket)
        return lefty_response
    ...
    def get_ticket(self, account_id, ticket_id, data_centre_url=None):
        """
            ...
            @type ticket_id: String
            @param account_id: Account id for which the ticket needs to be
                               created.
            @type account_id: String
        """
        ...
        lefty_response = self.request('GET', url, response_entity_type=Ticket)
        return lefty_response
    ...
    def search_events_by_attribute(self, event_list, attribute, attribute_val):
        """
            ...
            @param attribute_val: Value for the Search attibute provided for
                                  events.
    ...
    def wait_for_ticket_to_sync_in_data_centre(self, data_centre_url,
        ...
        """
            ...
            @returntype: None
            @param data_centre_url: URL of the data centre where data
                                    should be synced.
...
class LeftyAPICategrySubCategoryClient(BaseMarshallingClient):
    def __init__(self, url, auth_token, serialize_format=None,
                 deserialize_format=None):
        super(LeftyAPICategrySubCategoryClient, self).__init__(
    ...
    def list_categories(self):
        ...
        lefty_response = self.request('GET', url,
                                      response_entity_type=Categories)
        return lefty_response
    ...
    def list_sub_categories(self, category_id):
        """
            ...
            @returntype: Response Object
            @param category_id: ID of the category for which the Subcategories
                                to be listed.
            @type category_id: String
        """
        ...
        lefty_response = self.request('GET', url,
                                      response_entity_type=Subcategories)
        return lefty_response
...
class LeftyAPIQueueClient(BaseMarshallingClient):
    ...
    def create_queue(self, name, description, query_occurrence, query_property,
                     query_value, sort_property, sort_order):
        """
            ...
            @param query_value: Query value for the Queue
            @type query_value: String
        ...
        queue_query_request = QueueQuery(query_occurrence, query_property,
                                         query_value)
        ...
        lefty_response = self.request('POST', url,
                                      request_entity=create_queue_request,
    ...
    def get_tickets_for_a_queue(self, queue_id, count=None, offset=None):
        """
            @summary: Retrieves the list of Tickets for a Queue.
            @returntype: List
            @param queue_id: ID of the Queue for which the tickets to be
                             fetched
            @type queue_id: String
            @param count: number of tickets to be returned
            @type count: Int
            @param offset: Offset of the returned ticket list
            @type offset: Int
        """

        url = '{0}/queues/{1}/tickets'.format(self.url, queue_id)
        params = {"count": count, "offset": offset}
        lefty_response = self.request('GET', url, params=params,
                                      response_entity_type=Queue)
        return lefty_response

    def list_queues(self, count=None, offset=None):
        """
            @summary: Retrieves the list of available queues.
            @returntype: List
            @param count: number of queues to be returned
            @type count: Int
            @param offset: Offset of the returned queue list
            @type offset: Int
        """
    ...
    def get_occurrences(self):
        """
            @summary: Lists all occurrences for creating Queue.
            @returntype: List
        """
        url = '{0}/queues/occurrences'.format(self.url)
        lefty_response = self.request('GET', url, response_entity_type=Queue)
        return lefty_response

    def get_properties(self):
        """
            @summary: Lists all properties for creating Queue.
            @returntype: List
        """
        url = '{0}/queues/properties'.format(self.url)
        lefty_response = self.request('GET', url, response_entity_type=Queue)
        return lefty_response

    def get_types(self):
        """
            @summary: Lists all types for creating Queue.
            @returntype: List
        """
        url = '{0}/queues/types'.format(self.url)
        lefty_response = self.request('GET', url, response_entity_type=Queue)
        return lefty_response
