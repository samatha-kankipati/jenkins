...
class RaxSignupAPIClient(BaseMarshallingClient):
    def __init__(self, base_url, auth_token, ah_endpoint, identity_endpoint,
        ...
        self.affiliate_id_source = affiliate_id_source
    ...
    def signup_new_cloud_customer(
            ...
            geo_location=None, geography=None, default_region=None,
            data=None, requestslib_kwargs=None):
        '''
        POST
        /v1/signups
        '''
        ...
        if data is None:
            signup_request_entity = CloudSignupRequest(
                ...
                geo_location=geo_location, geography=geography,
    ...
    def signup_new_email_and_apps_customer(
            ...
            skip_fraud_check=None, geo_location=None, geography=None,
            default_region=None, data=None, requestslib_kwargs=None):
            '''
            POST
            /v1/signups
            '''
            ...
            if data is None:
                signup_request_entity = EmailAndAppsSignupRequest(
                    ...
                    geography=geography, default_region=default_region)
    ...
    def get_transaction_id(self):
        '''
        GET http://rackspacetesting.go2cloud.org/SH2I
        '''
        url = '{0}'.format(self.affiliate_id_source)
        return self.request('GET', url)
