...
class MasterConfigProvider(_BaseConfigProvider):
    ...
    def __init__(self, SafeConfigParserObject=None):
        ...
        self.default_role_id = \
            _ConfigDomainObjects.DefaultRoleIdConfig(self.info)
        ...
        self.dual_mode_api = _ConfigDomainObjects.DualModeAPIConfig(self.info)
        ...
        self.support_service = _ConfigDomainObjects.SupportServicesConfig(
            self.info)
        ...
        self.encore = _ConfigDomainObjects.EncoreConfig(self.info)
        ...
        self.mailgun = _ConfigDomainObjects.MailgunAPIConfig(self.info)
        self.service_mix = _ConfigDomainObjects.ServiceMixAPI(self.info)
        self.valkyrie = _ConfigDomainObjects.ValkyrieConfig(self.info)
        self.rad = _ConfigDomainObjects.RADConfig(self.info)
        self.zendesk = _ConfigDomainObjects.ZendeskConfig(self.info)
        self.flow = _ConfigDomainObjects.FlowConfig(self.info)
