...
class IdentityAPIConfig(_BaseConfig):
    ...
    def token_entropy(self):
        return self.get("token_entropy")

    @property
    def cloud_token_ttl(self):
        return self.get("cloud_token_ttl")

    @property
    def impersonation_token_ttl(self):
        return self.get('impersonation_token_ttl')
    ...
    @property
    def imp_racker_token_ttl(self):
        return self.get('imp_racker_token_ttl')

    @property
    def imp_admin_token_ttl(self):
        return self.get('imp_admin_token_ttl')

    @property
    def v1_default_mosso(self):
        return literal_eval(self.get('v1_default_mosso'))

    @property
    def v1_default_nast(self):
        return literal_eval(self.get('v1_default_nast'))

    @property
    def default_services(self):
        return literal_eval(self.get('default_services'))
    ...
    @property
    def subuser_limit(self):
        return self.get('subuser_limit')

    @property
    def service_username_to_test(self):
        return self.get('service_username_to_test')

    @property
    def service_password_to_test(self):
        return self.get('service_password_to_test')

    @property
    def cloudfiles_role_id(self):
        return self.get('cloudfiles_role_id')
...
class AuthConfig(_BaseConfig):
    ...
    def admin_tenant_id(self):
        return self.get('admin_tenant_id')
    ...
    @property
    def admin_auth_version(self):
        return self.get("admin_auth_version")
    ...
    @property
    def alt_version(self):
        return self.get("alt_version")

    @property
    def zendesk_ticket_url(self):
        return self.get("zendesk_ticket_url")

    @property
    def zendesk_username(self):
        return self.get("zendesk_username")

    @property
    def zendesk_password(self):
        return self.get("zendesk_password")

    @property
    def zendesk_version(self):
        return self.get("zendesk_version")
...
class DefaultRoleIdConfig(_BaseConfig):
    SECTION_NAME = 'default_role_id'

    @property
    def identity_user_default_role_id(self):
        return self.get("identity_user_default_role_id")

    @property
    def user_admin_default_role_id(self):
        return self.get("user_admin_default_role_id")

    @property
    def sub_user_default_role_id(self):
        return self.get("sub_user_default_role_id")

    @property
    def role_with_weight_100_id(self):
        return self.get("role_with_weight_100_id")

    @property
    def role_with_weight_500_id(self):
        return self.get("role_with_weight_500_id")

    @property
    def role_with_weight_1000_id(self):
        return self.get("role_with_weight_1000_id")

    @property
    def role_with_weight_2000_id(self):
        return self.get("role_with_weight_2000_id")
...
class SecretsConfig(_BaseConfig):
    SECTION_NAME = 'properties'

    @property
    def ldap_bind_password(self):
        return self.get("ldap.bind.password")

    @property
    def crypto_password(self):
        return self.get("crypto.password")

    @property
    def crypto_salt(self):
        return self.get("crypto.salt")

    @property
    def ga_username(self):
        return self.get("ga.username")

    @property
    def ga_password(self):
        return self.get("ga.password")
...
class LavaAPIConfig(_BaseConfig):
    ...
    def ADMIN_API_URL(self):
        """Base URL for lava admin api"""
        return self.get("ADMIN_API_URL")
    ...
    @property
    def PROFILE_KEY_FILE_NAME(self):
        return self.get("PROFILE_KEY_FILE_NAME")

    @property
    def MANUAL_KEY_FILE_NAME(self):
        return self.get("MANUAL_KEY_FILE_NAME")
...
class ComputeAPIConfig(_BaseConfig):
    ...
    @property
    def ssh_retries(self):
        return int(self.get('ssh_retries', 5))
    ...
    @property
    def nova_event_type_in_atom_hopper_feed(self):
        return self.get('nova_event_type_in_atom_hopper_feed',
    ...
    @property
    def snapshot_gb_file_size(self):
        return float(self.get('snapshot_gb_file_size'))
    ...
    @property
    def highio_instance_type_id_dict(self):
        return literal_eval(self.get('highio_instance_type_id_dict'))

    @property
    def region_datacenter_mapping(self):
        return literal_eval(self.get('region_datacenter_mapping'))

    def expected_event_types(self):
        return list(self.get('expected_event_types'))

    @property
    def bypass_url(self):
        return self.get('bypass_url')
...
class DualModeAPIConfig(_BaseConfig):
    SECTION_NAME = 'dual_mode'

    @property
    def public_network_bridge(self):
        return self.get('public_network_bridge')

    @property
    def service_network_bridge(self):
        return self.get('service_network_bridge')

    @property
    def isolated_network_bridge(self):
        return self.get('isolated_network_bridge')

    @property
    def flows_type(self):
        return self.get('flows_type')

    @property
    def nova_scheduler_ip(self):
        return self.get('nova_scheduler_ip')
...
class IsolatedNetworksAPIConfig(_BaseConfig):
    ...
    @property
    def run_nvp(self):
        return self.get('run_nvp', default=False)

    @property
    def ifconfig_order_check(self):
        return self.get('ifconfig_order_check', default=False)

    @property
    def leave_test_instances(self):
        return self.get('leave_test_instances', default=False)
...
class LoadBalancersAPIConfig(_BaseConfig):
    ...
    @property
    def prod_admin_role_user(self):
        return self.get('prod_admin_role_user')

    @property
    def prod_admin_role_password(self):
        return self.get('prod_admin_role_password')
    ...
    @property
    def global_admin_role_user(self):
        return self.get('global_admin_role_user')

    @property
    def global_admin_role_password(self):
        return self.get('global_admin_role_password')

    @property
    def global_observer_role_user(self):
        return self.get('global_observer_role_user')

    @property
    def global_observer_role_password(self):
        return self.get('global_observer_role_password')

    @property
    def rbac_roles_data_file(self):
        return self.get('rbac_roles_data_file')
...
class LegacyServAPIConfig(_BaseConfig):
    ...
    @property
    def flavor_ref(self):
        return int(self.get('flavor_ref'))

    @property
    def image_ref(self):
        return int(self.get('image_ref'))

    @property
    def build_interval(self):
        return float(self.get('build_interval'))
...
class ImagesAPIConfig(_BaseConfig):
    ...
    @property
    def alt_build_interval(self):
        return self.get('alt_build_interval')
    ...
    @property
    def server_task_state_timeout(self):
        """Time out to wait for server's task state."""
        return self.get('server_task_state_timeout')
...
class TQSearchConfig(_BaseConfig):
    ...
    @property
    def subject_1(self):
        return self.get('subject_1')

    @property
    def assignee_user_id(self):
        return self.get('assignee_user_id')

    @property
    def assignee_user_name(self):
        return self.get('assignee_user_name')

    @property
    def account_number_5(self):
        return self.get('account_number_5')
    ...
    @property
    def priority_2(self):
        return self.get('priority_2')

    @property
    def queue_id_ref(self):
        return self.get('queue_id_ref')

    @property
    def sleep_100_sec(self):
        return self.get('sleep_100_sec')

    @property
    def sleep_30_sec(self):
        return self.get('sleep_30_sec')

    @property
    def team_number(self):
        return self.get('team_number')

    @property
    def queue_id_alt_ref(self):
        return self.get('queue_id_alt_ref')

    @property
    def team_name_alt(self):
        return self.get('team_name_alt')

    @property
    def queue_id_alt(self):
        return self.get('queue_id_alt')

    @property
    def queue_id_alt_ref_1(self):
        return self.get('queue_id_alt_ref_1')

    @property
    def queue_id_alt_ref_2(self):
        return self.get('queue_id_alt_ref_2')

    @property
    def status_5(self):
        return self.get('status_5')

    @property
    def utc_start_time_3(self):
        return self.get('utc_start_time_3')
    ...
    @property
    def account_territory_code(self):
        return self.get('account_territory_code')

    @property
    def account_service_level(self):
        return self.get('account_service_level')
...
class LeftyConfig(_BaseConfig):
    ...
    @property
    def base_url_dfw(self):
        return self.get('base_url_dfw')

    @property
    def base_url_ord(self):
        return self.get('base_url_ord')

    @property
    def sync_wait_time(self):
        return self.get('sync_wait_time')


class SupportServicesConfig(_BaseConfig):
    SECTION_NAME = 'support_service'
    ...
    def service_level(self):
        return self.get('service_level')

    @property
    def linked_account(self):
        return self.get('linked_account')
    ...
    @property
    def group_with_users(self):
        return self.get('group_with_users')
...
class RaxSignupConfig(_BaseConfig):
    ...
    def wait_in_seconds(self):
        return self.get('wait_in_seconds')

    @property
    def affiliate_code(self):
        return self.get('affiliate_code')

    @property
    def affiliate_id_source(self):
        return self.get('affiliate_id_source')

    @property
    def welcome_email_templates(self):
        return self.get('welcome_email_templates')
...
class ManagedCloudConfig(_BaseConfig):
    ...
    @property
    def legacy_flavor(self):
        return self.get('legacy_flavor')
    ...
    @property
    def backup_agent_url(self):
        return self.get('backup_agent_url')
...
class CoreConfig(_BaseConfig):
    ...
    def contract_id(self):
        return int(self.get('contract_id'))

    @property
    def computer_id(self):
        return int(self.get('computer_id'))

    @property
    def employee_num(self):
        return int(self.get('employee_num'))

    @property
    def datacenter_id(self):
        return self.get('datacenter_id')

    @property
    def support_team_id(self):
        return self.get('support_team_id')

    @property
    def support_team_name(self):
        return self.get('support_team_name')

    @property
    def special_account_id(self):
        return self.get('special_account_id')

    @property
    def certificate_id(self):
        return int(self.get('certificate_id'))

    @property
    def snapshot_date(self):
        return self.get('snapshot_date')

    @property
    def ctkapi_modules(self):
        return int(self.get('ctkapi_modules'))


class EncoreConfig(_BaseConfig):
    SECTION_NAME = 'encore'
    ...
    @property
    def device_num(self):
        return self.get('device_num')


class RADConfig(_BaseConfig):
    SECTION_NAME = 'rad'
...
class AtomHopperConfig(_BaseConfig):
    ...
    def wait_interval(self):
        return int(self.get("wait_interval", default=10))

    @property
    def wait_timeout(self):
        return int(self.get("wait_timeout", default=600))
...
class AtomHopperEvents(_BaseConfig):
    ...
    @property
    def ah_resource_id(self):
        return self.get('ah_resource_id')

    @property
    def ah_resource_name(self):
        return self.get('ah_resource_name')


class UserIdentity(_BaseConfig):
    SECTION_NAME = 'user_identity'
...
class RackConnectConfig(_BaseConfig):
    ...
    @property
    def centos_image_ref(self):
        return self.get('centos_image_ref')

    @property
    def ubuntu_image_ref(self):
        return self.get('ubuntu_image_ref')
    ...
    @property
    def default_flavor_ref(self):
        return self.get('default_flavor_ref')

    @property
    def windows_flavor_ref(self):
        return self.get('windows_flavor_ref')


class MailgunAPIConfig(_BaseConfig):
...
class ServiceMixAPI(_BaseConfig):
    SECTION_NAME = 'service_mix'
...
class ValkyrieConfig(_BaseConfig):
    SECTION_NAME = 'valkyrie'
    ...
    @property
    def valkyrie_dedicated_account(self):
        return self.get('valkyrie_dedicated_account')

    @property
    def valkyrie_cloud_account(self):
        return self.get('valkyrie_cloud_account')

    @property
    def valkyrie_test_ticket(self):
        return self.get('valkyrie_test_ticket')


class ZendeskConfig(_BaseConfig):
    SECTION_NAME = 'zendesk'
...
class FlowConfig(_BaseConfig):
    ...
    @property
    def testuser4_zd_id(self):
        return self.get('testuser4_zd_id')

    @property
    def flow_hybrid_int_smb_id(self):
        return self.get('flow_hybrid_int_smb_id')

    @property
    def zd_hybrid_int_smb_id(self):
        return self.get('zd_hybrid_int_smb_id')

    @property
    def testuser4_user_name(self):
        return self.get('testuser4_user_name')

    @property
    def testuser4_sso(self):
        return self.get('testuser4_sso')

    @property
    def wait_for_tickets(self):
        return self.get('wait_for_tickets')
