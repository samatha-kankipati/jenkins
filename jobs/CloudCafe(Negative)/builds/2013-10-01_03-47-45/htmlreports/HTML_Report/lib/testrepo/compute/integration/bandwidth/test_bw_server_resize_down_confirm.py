...
from testrepo.common.testfixtures.stacktach_db_compute_bandwidth_integration \
    import BwBeforeResizeDownConfirmServerFixture as \
    BwBeforeResizeDownCServerFixture, \
    BwAfterResizeDownConfirmServerFixture as BwAfterResizeDownCServerFixture, \
    BwBeforeAndAfterResizeDownConfirmServerFixture as \
    BwBAndAResizeDownCServerFixture, \
    NoBwResizeDownConfirmServerFixture as NoBwResizeDownCServerFixture


class BwBeforeResizeDownConfirmTests(BwBeforeResizeDownCServerFixture):
    '''
...
class BwAfterResizeDownConfirmTests(BwAfterResizeDownCServerFixture):
    '''
...
class BwBeforeAfterResizeDownConfirmTests(BwBAndAResizeDownCServerFixture):
    '''
...
class NoBwResizeDownConfirmTests(NoBwResizeDownCServerFixture):
    '''
