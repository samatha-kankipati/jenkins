...
class StackTachTest(StackTachFixture):
    ...
    def test_get_event_names(self):
        ...
        response = self.stacktach_provider.client.get_event_names()
    ...
    def test_get_host_names(self):
        ...
        response = self.stacktach_provider.client.get_host_names()
    ...
    def test_get_kpi_for_tenant_id(self):
        ...
        # XXXFN - change this so that we get a current active tenant id
        # maybe from the watch events
        tenant_id = (self.stacktach_provider
                     .get_tenant_id_from_event_id_details(
