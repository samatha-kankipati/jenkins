...
class ObjectSmokeTest(ObjectStorageTestFixture):
    ...
    def test_object_not_modified_with_if_modified_since_header(self):
        ...
        r = self.client.get_storage_object(container_name,
                                                       object_name,
                                                       headers=headers)
        self.assertEqual(r.status_code, 304, 'should not retrieve object')
    ...
    def test_object_precondition_fail_with_if_unmodified_since_header(self):
        ...
        self.assertEqual(r.status_code, 412, 'should not retrieve object')
    ...
    def test_partial_object_retrieval_with_range(self):
        ...
        r = self.client.get_storage_object(container_name,
                                                       object_name,
                                                       headers=headers)
        self.assertEqual(r.status_code, 206, 'should retrieve a partial ' \
                'object from the middle to the middle')
    ...
    def test_object_creation_with_chunked_transfer(self):
        """TODO(rich5317): implement creation of smoke test for chunked transfers"""
        ...
        #x = self.client.retrieve_storage_object(self.base_container_name, self.base_object_name)
        #self.assertEqual(x.status_code, 200)
        #self.assertEqual(x.content, 'thisisaseriesofchunks!!!')

        #x = self.client.delete_storage_object(self.base_container_name, self.base_object_name)
    ...
    def test_versioned_contaner_creation_with_valid_data(self):
        ...
        non_current_version_container_name = \
                self.client.generate_unique_container_name('_non-current')
        ...
        current_version_container_name = \
                self.client.generate_unique_container_name('_current')
    ...
    def test_object_deletion_with_valid_object(self):
        ...
        r = self.client.delete_storage_object(container_name,
                                                          object_name)
