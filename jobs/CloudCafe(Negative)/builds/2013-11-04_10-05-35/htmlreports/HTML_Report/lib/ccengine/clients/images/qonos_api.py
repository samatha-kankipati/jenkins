...
class SchedulesClient(BaseMarshallingClient):
    ...
    ''' @TODO: Look into the order of parameters '''
    def create_schedule(self, tenant=None, action=None, minute=None,
                          ...
                          http_method="POST", requestslib_kwargs=None):
        ...
        return self.request(http_method, self.url, request_entity=schedule,
    ...
    def update_schedule(self, id=None, hour=None, tenant=None,
                          ...
                          http_method="PUT", requestslib_kwargs=None):
        ...
        return self.request(http_method, full_url, request_entity=schedule,
                            response_entity_type=SchResponse,
                            requestslib_kwargs=requestslib_kwargs)
    ...
    def set_schedule_metadata(self, id=None, keys=None, values=None,
                              sub_url="metadata", http_method="PUT",
                              bad_body=None, requestslib_kwargs=None):

        full_url = "{0}/{1}/{2}".format(self.url, id, sub_url)

        metadata = MetaRequest(keys=keys, values=values, bad_body=bad_body)

        return self.request(http_method, full_url, request_entity=metadata,
                            response_entity_type=MetaResponse,
                            requestslib_kwargs=requestslib_kwargs)

    def list_schedule_metadata(self, id=None, http_method="GET",
                               url_addition=None, requestslib_kwargs=None):

        if url_addition is not None:
            full_url = "{0}/{1}/metadata{2}".format(self.url, id, url_addition)
        else:
            full_url = "{0}/{1}/metadata".format(self.url, id)

        return self.request(http_method, full_url,
                            response_entity_type=MetaResponse,
                            requestslib_kwargs=requestslib_kwargs)

    def get_incorrect_base_url(self, url_addition=None,
                               requestslib_kwargs=None):

        full_url = "{0}{1}".format(self.url, url_addition)

        self.request("GET", full_url, response_entity_type=SchResponse,
                     requestslib_kwargs=requestslib_kwargs)
    ...
    def update_schedule_incorrect_parameter(self, id=None, hour=None,
                                            tenant=None, updated_at=None,
                                            day_of_week=None,
                                            day_of_month=None, metadata=None,
                                            last_scheduled=None, action=None,
                                            month=None, minute=None,
                                            bad_param=None,
                                            requestslib_kwargs=None):
        ...
        schedule = SchRequest(tenant=tenant, action=action, minute=minute,
                              hour=hour, day_of_month=day_of_month,
                              month=month, day_of_week=day_of_week,
                              metadata=metadata, bad_param=bad_param)

        return self.request("PUT", full_url, response_entity_type=SchResponse,
                            request_entity=schedule,
                            requestslib_kwargs=requestslib_kwargs)
...
class WorkersClient(BaseMarshallingClient):
    ...
    def get_worker(self, id=None, http_method="GET", url_addition=None,
                   requestslib_kwargs=None):

        if url_addition is not None:
            full_url = "{0}/{1}{2}".format(self.url, id, url_addition)
        else:
            full_url = "{0}/{1}".format(self.url, id)
    ...
    def list_workers(self, http_method="GET", url_addition=None, keys=None,
        ...
        return self.request(http_method, full_url, params=params,
                            response_entity_type=WorkerResponse,
                            requestslib_kwargs=requestslib_kwargs)
...
class JobsClient(BaseMarshallingClient):
    ...
    def create_job(self, schedule_id=None, requestslib_kwargs=None):
        ...
        return self.request("POST", self.url, response_entity_type=JobResponse,
                            request_entity=job,
                            requestslib_kwargs=requestslib_kwargs)

    def get_job(self, id=None, requestslib_kwargs=None):

        full_url = "{0}/{1}".format(self.url, id)

        return self.request("GET", full_url, response_entity_type=JobResponse,
                            requestslib_kwargs=requestslib_kwargs)
