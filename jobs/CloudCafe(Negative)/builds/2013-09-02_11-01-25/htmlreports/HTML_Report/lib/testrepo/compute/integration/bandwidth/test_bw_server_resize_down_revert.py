...
from testrepo.common.testfixtures.stacktach_db_compute_bandwidth_integration \
    import BwBeforeResizeDownRevertServerFixture as \
    BwBeforeResizeDownRevertFixture, \
    BwAfterResizeDownRevertServerFixture as BwAfterResizeDownRevertFixture, \
    BwBeforeAndAfterResizeDownRevertServerFixture as \
    BwBAndAResizeDownRevertFixture, \
    NoBwResizeDownRevertServerFixture as NoBwResizeDownRevertFixture


class BwBeforeResizeDownRevertTests(BwBeforeResizeDownRevertFixture):
    '''
...
class BwAfterResizeDownRevertTests(BwAfterResizeDownRevertFixture):
    '''
...
class BwBeforeAfterResizeDownRevertTests(BwBAndAResizeDownRevertFixture):
    '''
...
class NoBwResizeDownRevertTests(NoBwResizeDownRevertFixture):
    '''
