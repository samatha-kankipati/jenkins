...
from testrepo.common.testfixtures.rax_signup import\
    RaxSignupAPI_TrustedCloudSignupFixture_UK, CreditCards


class RaxSignupAPI_TrustedCloudSignupRequest_UK_NegativeSmoke(
    ...
    def test_uk_trusted_cloud_signup_without_region(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        without Region
        """
    ...
    def test_uk_trusted_cloud_signup_without_account_name(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_accept_terms_and_conditions(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_with_existing_username_details(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_username(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        without Username
        """
    ...
    def test_uk_trusted_cloud_signup_without_password(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        without Password
        """
    ...
    def test_uk_trusted_cloud_signup_without_secret_question(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_secret_answer(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        without Secert Answer
        """
    ...
    def test_uk_trusted_cloud_signup_without_complete_contact_details(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_with_missing_contact_address_details(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        with missing Contact Address Details
        """
    ...
    def test_uk_trusted_cloud_signup_with_missing_contact_email_address(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        with missing Contact Email Address
        """
    ...
    def test_uk_trusted_cloud_signup_with_missing_contact_phone_number(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_first_name(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_last_name(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_address_country(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_address_primary(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_address_street(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_email_address(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_email_address_primary(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_phone_number_primary(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_phone_number(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_contact_phone_number_country(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    @attr('failing', '500')
    def test_uk_trusted_cloud_signup_without_contact_phone_number_category(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_with_all_payment_card_details_missing(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_card_expiration_date(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_card_type(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        without Card Type
        """
    ...
    def test_uk_trusted_cloud_signup_without_card_verification_number(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_without_complete_payment_details(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_with_all_payment_method_info_missing(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        with all Payment Method Info missing
        """
    ...
    def test_uk_trusted_cloud_signup_without_consolidated_invoice_and_payment_card(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_with_no_managed_account_number_in_ci_and_payment_card(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_request_without_complete_contact_roles(self):
        """
    ...
    def test_uk_trusted_cloud_signup_request_without_contact_primary_role(self):
        """
        Scenario: Create UK Trusted Cloud Account through Signup Facade without
    ...
    def test_uk_trusted_cloud_signup_request_without_contact_billing_role(self):
        """
        Scenario: Create UK Trusted Cloud Account through Signup Facade without
    ...
    def test_uk_trusted_cloud_signup_request_without_both_contact_roles(self):
        """
        Scenario: Create UK Trusted Cloud Account through Signup Facade without
        both Contact Roles
        """
    ...
    def test_uk_trusted_cloud_signup_with_invalid_business_type(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_with_invalid_terms_and_conditions(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_request_with_invalid_card_type(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_request_without_card_number(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        without Card Number
        """
    ...
    def test_uk_trusted_cloud_signup_request_without_card_holder_name(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
    ...
    def test_uk_trusted_cloud_signup_request_with_mismatch_card_number_and_card_type(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade
        with Mismatch Card Number and Card Type
        """
        default_payment_card = {'card_number': CreditCards.MASTER_CARD_NUMBER,
    ...
    def test_uk_trusted_cloud_signup_request_with_no_card_expiration_date(self):
        """
    ...
    def test_uk_trusted_cloud_signup_request_with_incorrect_card_expiration_date(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_improper_card_expiration_date_format(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_no_card_number(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_improper_card_number_format(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_invalid_card_number(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_no_card_type(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_card_type_in_lower_case_format(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_card_type_in_camel_case_format(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_no_card_verification_number(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_improper_length_for_card_verification_number(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_invalid_card_verification_number(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
    ...
    def test_uk_trusted_cloud_signup_request_with_no_card_holder_name(self):
        """
        Scenario: Create UK Trusted Cloud Account through SignUp Facade with
