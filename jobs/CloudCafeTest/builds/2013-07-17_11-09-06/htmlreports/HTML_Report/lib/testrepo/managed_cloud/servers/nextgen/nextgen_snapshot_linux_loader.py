...
from ccengine.common.data_generators.managed_cloud. \
    nextgen_snapshot_linux_servers_generator \
    import ManagedCloudLinuxNextGenSnapshotDataGenerator
from unittest2.suite import TestSuite


def load_tests(loader, standard_tests, pattern):
    suite = TestSuite()
    smoke_data_gen = ManagedCloudLinuxNextGenSnapshotDataGenerator()
