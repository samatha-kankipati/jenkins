...
def load_tests(loader, standard_tests, pattern):
    data_generator = LavaAPIDataGenerator()
    cluster_loader = BaseParameterizedLoader(data_generator)
    cluster_loader.addTest(_SmokeLavaAPITest("test_add_cluster"))
    cluster_loader.addTest(_SmokeLavaAPITest("test_resize_cluster"))
    cluster_loader.addTest(_SmokeLavaAPITest("test_cluster_nodes"))
    cluster_loader.addTest(_SmokeLavaAPITest("test_node_web_pages"))
