...
class _Flavors(_BaseLavaAPIClient):
    def __init__(self, url, auth_token, serialize_format, deserialize_format):
        super(_Flavors, self).__init__(url,
                                       ...
                                       serialize_format,
                                       deserialize_format)
        self.url = self.base_url + 'flavors'
...
class _Clusters(_BaseLavaAPIClient):
    def __init__(self, url, auth_token, serialize_format, deserialize_format):
        super(_Clusters, self).__init__(url,
                                        ...
                                        serialize_format,
                                        deserialize_format)
        self.url = self.base_url + 'clusters'
    ...
    def get_node(self, cluster_id, node_id):
        ...
        '''
        url = self.url + "/" + str(cluster_id) + "/nodes/" + node_id
        return self.request("GET",
                            url,
