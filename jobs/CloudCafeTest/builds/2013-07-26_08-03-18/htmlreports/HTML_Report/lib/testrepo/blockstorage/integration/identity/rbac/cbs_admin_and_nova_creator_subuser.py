...
class RBAC_CBS_SubUser_CBSAdmin_and_NovaCreatorRoles(
        rbac_fixtures.RBAC_CBS_SubUserTestFixture):
    NOVA_CREATOR = 'nova:creator'

    @classmethod
    def setUpClass(cls):
        super(RBAC_CBS_SubUser_CBSAdmin_and_NovaCreatorRoles, cls).setUpClass()
    ...
    @attr('smoke')
    def test_actual_test_user_is_nova_creator(self):
        self.assert_actual_test_user_has_role(self.NOVA_CREATOR)
