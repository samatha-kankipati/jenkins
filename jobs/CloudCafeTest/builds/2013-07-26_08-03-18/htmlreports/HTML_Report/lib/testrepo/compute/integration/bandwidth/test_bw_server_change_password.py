...
from testrepo.common.testfixtures.stacktach_db_compute_bandwidth_integration \
    ...
    BwBeforeAndAfterChangePasswordServerFixture as \
    BwBAndAChangePasswordServerFixture, NoBwChangePasswordServerFixture
...
class BwBeforeAfterChangePasswordTests(BwBAndAChangePasswordServerFixture):
    '''
