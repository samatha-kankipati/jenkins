class V1_1Constants(object):
    XML_NS = 'http://docs.rackspacecloud.com/auth/api/v1.1'
    XML_NS_OPENSTACK = 'http://docs.openstack.org/common/api/v1.0'
    XML_NS_ATOM = 'http://www.w3.org/2005/Atom'
    XML_NS_CORE_EVENT = 'http://docs.rackspace.com/core/event'
