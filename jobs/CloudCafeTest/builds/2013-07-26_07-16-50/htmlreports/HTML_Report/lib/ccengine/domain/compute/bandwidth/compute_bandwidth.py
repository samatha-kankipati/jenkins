...
class BandwidthTestResults(object):
    ...
    def __init__(self, test_results_dict):
        '''
        ...
        @note: The structure of the dict being passed in looks
            like this:
    ...
    # this is where we have an expected but no actual
    @property
    def total_not_found_count(self):
