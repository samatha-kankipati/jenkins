...
class TestListTickets(TQSearchFixture):
    ...
    @attr(type='positive99', module='read', suite='smoke')
    ...
    def test_get_specific_ticket_and_verify_it_exists_in_the_list(self):
        ...
        tq_search_ticket = self.gate_provider.search_client.\
            get_specific_ticket_from_core(number=ticket_list_from_core[0]
                                          .number).entity

        self.assertEquals(tq_search_ticket.ticket, core_ticket,
