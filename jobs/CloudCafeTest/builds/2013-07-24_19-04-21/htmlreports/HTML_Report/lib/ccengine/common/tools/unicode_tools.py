...
class BLOCK_NAMES(object):
    ...
    ethiopic = "Ethiopic"
    cherokee = "Cherokee"
    unified_canadian_aboriginal_syllabics = ("Unified Canadian Aboriginal"
                                             " Syllabics")
    ogham = "Ogham"
    runic = "Runic"
    tagalog = "Tagalog"
    ...
    combining_diacritical_marks_for_symbols = ("Combining Diacritical Marks"
                                               " for Symbols")
    ...
    dingbats = "Dingbats"
    miscellaneous_mathematical_symbols_a = ("Miscellaneous Mathematical "
                                            "Symbols-A")
    supplemental_arrows_a = "Supplemental Arrows-A"
    braille_patterns = "Braille Patterns"
    supplemental_arrows_b = "Supplemental Arrows-B"
    miscellaneous_mathematical_symbols_b = ("Miscellaneous Mathematical"
                                            " Symbols-B")
    ...
    cjk_compatibility_ideographs_supplement = ("CJK Compatibility Ideographs"
                                               " Supplement")
    unused = "Unused"
    tags = "Tags"
...
class UnicodeRangeList(list):
    '''
    List-like collection of UnicodeRange objects. (Inherits from list)
...
# Initialize UNICODE_BLOCKS constant object
...
# Initialize UNICODE_PLANES constant object
