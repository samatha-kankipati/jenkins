...
class AccountAPIClient(CoreAPIClient):
    ...
    def get_account_team_attribute(self, load_value, attribute=None):
        '''
        @summary: Get Attribute value of an Contact module
        @param attributes: Attributes of Contact module
        @type attributes: String
        ...
        if attribute is None:
            attribute = ["id"]
        response = self.get_attribute(class_name="Account.Team",
                                      load_value=load_value,
                                      attribute=attribute)
        return response
    ...
    def get_session_details(self):
        ...
        @param auth_token: auth_token of an given account
        @type auth_token: string
        '''
        response = self.get_session_detail(self.auth_token)
        return response
    ...
    def update_account_team(self, account_number, attribute_name,
                            attribute_value):
        '''
        ...
        '''
        class_name = "Account.Team"
        ctk_object = CTKObject(class_name, attribute_value)
        given_attribute_value = ctk_object
        response = self.set_attribute(class_name="Account.Account",
                                      load_arg=account_number,
                                      attribute_name=attribute_name,
                                      attribute_value=given_attribute_value)
        return response