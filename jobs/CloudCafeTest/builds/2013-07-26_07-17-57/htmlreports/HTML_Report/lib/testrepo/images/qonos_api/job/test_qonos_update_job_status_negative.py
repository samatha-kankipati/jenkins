...
class TestQonosUpdateJobStatusNegative(BaseImagesFixture):
    ...
    def test_update_completed_job_status(self):
        ...
        8) Verify that a correct validation message is returned
        ...
        '''TODO: This should fail, need to test when environment allows'''
        update_job_status_obj = self.images_provider.jobs_client.\
            update_job_status(jobs[0].id, job_status=job_status)
