...
class BandwidthComputeValidatorFixture(BaseTestFixture):
    ...
    def check_missing_events(self, expected_events, actual_events_found):
        ...
        self.fixture_log.debug("len of actual uuids: {0}"
    ...
    def validate_events(self):
        ...
        @type test_resutls: BandwidthTestResults object
        '''
        ...
        bandwidth_test_result = self.validate_event_details(
