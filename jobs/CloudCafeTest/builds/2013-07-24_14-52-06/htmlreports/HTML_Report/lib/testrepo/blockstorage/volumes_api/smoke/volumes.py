...
def load_tests(loader, standard_tests, pattern):
    suite = TestSuite()
    print logging_tools.get_object_namespace(VolumesAPI_VolumesHappyPathTest)
    suite.addTest(VolumesAPI_VolumesHappyPathTest("test_create_volume"))
    suite.addTest(VolumesAPI_VolumesHappyPathTest("test_get_volume_info"))
    suite.addTest(VolumesAPI_VolumesHappyPathTest("test_list_volumes"))
    suite.addTest(
        VolumesAPI_VolumesHappyPathTest("test_list_detailed_volumes"))
    suite.addTest(VolumesAPI_VolumesHappyPathTest("test_update_volume_info"))
    suite.addTest(VolumesAPI_VolumesHappyPathTest("test_delete_volume"))
    return suite


class VolumesAPI_VolumesHappyPathTest(VolumesAPIFixture):
    """
    ...
    @classmethod
    def setUpClass(cls):
        super(VolumesAPI_VolumesHappyPathTest, cls).setUpClass()
        cls.expected_volumes = []
        cls.volume_types = cls.volumes_client.list_all_volume_types().entity

    @classmethod
    def tearDownClass(cls):
        super(VolumesAPI_VolumesHappyPathTest, cls).tearDownClass()
        cls.volumes_api_provider.cleanup_volumes(cls.expected_volumes)

    def test_create_volume(self):
        VOLUME_SIZE = str(self.volumes_api_provider.min_volume_size)
        for volume_type in self.volume_types:
            ...
            actual_volume.volume_type = self.volumes_api_provider.\
