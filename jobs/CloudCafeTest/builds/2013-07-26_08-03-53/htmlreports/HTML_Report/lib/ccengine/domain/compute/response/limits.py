...
class Limits(BaseMarshallingDomain):
    ...
    def _xml_to_obj(cls, serialized_str):
        '''Returns an instance of a Limits Response Object based on xml serialized str'''
        limits = {}
        rate_list = []
        absolute_dict = {}
        #Removing namespaces
        root = ET.fromstring(serialized_str)
        cls._remove_namespace(root, 'http://docs.openstack.org/common/api/v1.0')
        cls._remove_namespace(root, 'http://docs.openstack.org/common/api/v1.1')
        #Rates Limits        
        ...
        cls._remove_namespace(absolute_list, 'http://docs.openstack.org/compute/ext/used_limits/api/v1.1')
