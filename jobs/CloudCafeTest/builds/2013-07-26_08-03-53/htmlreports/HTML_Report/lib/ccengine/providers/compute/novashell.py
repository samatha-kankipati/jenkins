...
class NovaShellProvider(BaseProvider):
    ...
    def create_volume_from_snapshot(self, volume_name, volume_snapshot_name, volume_size=1, timeout=480):
        '''
        ...
        try:
            ...
            novaResponse = self.NovaShellClient.volume_create(display_name = volume_name, volume_type = volume_type_domain_object.Name, volume_size = volume_size, snapshot_id = volume_snapshot_id)
        except Exception, create_exception:
