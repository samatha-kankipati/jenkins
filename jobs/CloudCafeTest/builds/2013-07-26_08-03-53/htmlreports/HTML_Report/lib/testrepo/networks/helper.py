...
class Helper(unittest2.TestCase):
    ...
    def remote_ping(self, remote_client, ip_list, count=3,
        ...
        if not isinstance(ip_list, list):
            ip_list = [ip_list]
        msg = ('Network IP {0} ping from server {1} got unexpected '
        ...
        self.assertTrue(diff, msg.format(ip_list[index],
            remote_client.server_id, loss_pct, accepted_packet_loss_pct))

    def assert_ifconfig(self, server=None, ips=None, find=True, username=None,
                        order_list=None, remote_client=None):
        """
