...
from testrepo.common.testfixtures.stacktach_db_compute_bandwidth_integration \
    import BwBeforeResizeUpNoConfirmServerFixture as \
    BwBeforeResizeUpNCServerFixture, \
    BwAfterResizeUpNoConfirmServerFixture as BwAfterResizeUpNCServerFixture, \
    BwBeforeAndAfterResizeUpNoConfirmServerFixture as \
    BwBAndAResizeUpNCServerFixture, \
    NoBwResizeUpNoConfirmServerFixture as NoBwResizeUpNCServerFixture


class BwBeforeResizeUpNoConfirmTests(BwBeforeResizeUpNCServerFixture):
    '''
...
class BwAfterResizeUpNoConfirmTests(BwAfterResizeUpNCServerFixture):
    '''
...
class BwBeforeAfterResizeUpNoConfirmTests(BwBAndAResizeUpNCServerFixture):
    '''
...
class NoBwResizeUpNoConfirmTests(NoBwResizeUpNCServerFixture):
    '''
