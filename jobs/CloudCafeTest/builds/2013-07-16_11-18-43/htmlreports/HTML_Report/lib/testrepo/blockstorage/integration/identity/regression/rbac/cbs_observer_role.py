...
class RBAC_CBS_SubUser_CBSObserverRole(
        rbac_fixtures.RBAC_CBS_SubUserTestFixture):
    @classmethod
    def setUpClass(cls):
        super(RBAC_CBS_SubUser_CBSObserverRole, cls).setUpClass()
    ...
    def test_actual_test_user_is_cbs_observer(self):
        self.assert_actual_test_user_has_role(self.CBS_OBSERVER)
