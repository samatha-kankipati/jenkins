...
class AdminSecretQATest(IdentityAdminFixture):
    ...
    def test_admin_get_user_secret_qa_list(self):
        ...
        self.assertEqual(user_qa.status_code, 200,
                msg='Admin get user secret QA list expected 200 recieved %s' %
                user_qa.status_code)
    ...
    def test_admin_update_secret_qa(self):
        ...
        self.assertEqual(question.status_code, 201,
                msg="Admin create question expected response 201 received %s" %
        ...
        self.assertEqual(create_answer.status_code, 200,
                msg="Admin create secret QA expected response 200 received %s"
                % create_answer.status_code)
        ...
        self.assertEqual(update_answer.status_code, 200,
                msg="Admin update secret QA expected 200 received %s" %
                update_answer.status_code)
    ...
    def test_admin_get_questions(self):
        ...
        self.assertEqual(get_questions.status_code, 200,
            msg="Admin get questions expected response 200 received %s" %
            get_questions.status_code)
    ...
    def test_get_question(self):
        ...
        get_question = self.admin_client.get_question(questionId=question_id)

        self.assertEqual(get_question.status_code, 200,
                msg="Admin get question expected response 200 received %s" %
    ...
    def test_admin_update_question(self):
        ...
        self.assertEqual(update_question.status_code, 204,
                msg="Admin update question expected response 204 received %s" %
                update_question.status_code)
    ...
    def test_admin_delete_question(self):
        ...
        self.assertEqual(del_question.status_code, 204,
                msg="Admin delete question expected response 204 received %s" %
                del_question.status_code)

        get_question = self.admin_client.get_question(questionId=question_id)

        self.assertEqual(get_question.status_code, 404,
                msg="Admin get question expected response 404 received %s" %
                get_question.status_code)
